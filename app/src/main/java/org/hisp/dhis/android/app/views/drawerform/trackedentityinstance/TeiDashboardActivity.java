...
import org.hisp.dhis.android.app.views.drawerform.trackedentityinstance.drawer.TeiNavigationView;
...
public class TeiDashboardActivity extends FragmentActivity implements TeiDashboardView, ReportEntitySelection {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if (isRegistrationComplete()) {
                formFragment = FormFragment.newEmptyForm(useTwoPaneLayout());
    ...
    private void injectDependencies(Bundle savedInstanceState) {
        ...
        TeiDashboardComponent teiDashboardComponent = ((SkeletonApp) getApplication()).getTeiDashboardComponent();
    ...
    private FormFragment retainFormFragment() {
        if (getSupportFragmentManager().findFragmentByTag(TAG_FORM_FRAGMENT) != null) {
            ...
            if (isRegistrationComplete()) {
                return FormFragment.newEmptyForm(useTwoPaneLayout());
            } else {
