...
public class FormPresenterImpl implements FormPresenter {
    private static final String TAG = FormPresenterImpl.class.getSimpleName();
    ...
    public FormPresenterImpl(ProgramInteractor programInteractor,
...
//                        rxRuleEngine.notifyDataSetChanged();
                ...
                .subscribe(new Action1<Enrollment>() {
                    ...
                    public void call(Enrollment enrollment) {
                        ...
                        if (formView != null) {
                            formView.showEnrollmentStatus(enrollment.enrollmentStatus());
                        }
        ...
        subscription.add(getEvent(form.getDataModelUid())
                ...
                .subscribe(new Action1<Event>() {
                    ...
                    public void call(Event event) {
                        ...
                        if (formView != null) {
                            formView.showEventStatus(event.status());
                        }
                        ...
                        for (ProgramStage programStage : programStages) {
                            if (programStage.uid().equals(form.getProgramStageUid())) {
                                ...
                                if (formView != null) {
                                    formView.setForm(builder.build());
                                    formView.showFormTitle(programStage.displayName());
                                }
                                break;
                            }
                        }
    ...
    public List<FormEntity> getInvalidFormEntities() {
        return formView.getInvalidFormEntities();
    }
                    ...
                    public void call(Program program) {
                        if (formView != null) {
                            ...
                            if (program.captureCoordinates()) {
                                ...
                                formView.showCoordinatesPicker(latitude, longitude);
                            }
                        }
                    }
                }, new Action1<Throwable>() {
        ...
        return getProgram(programUid)
                .map(new Func1<Program, AbstractMap.SimpleEntry<Picker, List<FormSection>>>() {
                    ...
                    public AbstractMap.SimpleEntry<Picker, List<FormSection>> call(Program program) {
                        ...
                        if (formView != null) {
                            chooseSectionPrompt = formView.getFormSectionLabel(
                                    FormView.ID_CHOOSE_SECTION);
                        }
                    ...
                    public void call(AbstractMap.SimpleEntry<Picker, List<FormSection>> results) {
                        if (results != null && formView != null) {
                            ...
                            if (results.getValue() == null || results.getValue().isEmpty()) {
                                ...
                                //formView.showFormDefaultSection(results.getKey().getId(), programUid, programStageUid);
                            } else {
                                //formView.showFormSections(results.getValue(), programUid, programStageUid);
                                formBuilder.setFormSections(results.getValue());
                                formView.setFormSectionsPicker(results.getKey());
                            }

                            formView.showForm(formBuilder.build());
                        }
                    }
                }, new Action1<Throwable>() {
                    @Override
