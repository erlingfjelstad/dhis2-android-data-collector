...
/* TODO: fix the injection stuff :
        ...
        ActivityComponent activityComponent = ((SkeletonApp) getApplication()).getActivityComponent();
        ...
        if (savedInstanceState == null) {
            ...
            activityComponent = ((SkeletonApp) getApplication()).createActivityComponent();

        } else {
            activityComponent = ((SkeletonApp) getApplication()).getActivityComponent();
        }
